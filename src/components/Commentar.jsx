...
const Komentar = () => {
    ...
    const handleCommentSubmit = useCallback(async ({ newComment, userName, imageFile }) => {
        ...
        try {
            ...
            // Insert comment - MUST use is_pinned: false due to RLS policy
            const { error } = await supabase
                ...
                .insert({
                    ...
                    is_pinned: false, // IMPORTANT: Must be false due to RLS policy
            ...
            // Success - form will be cleared by CommentForm
