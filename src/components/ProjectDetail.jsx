...
const handleGithubClick = (githubLink) => {
  if (githubLink === 'Private' || !githubLink || githubLink === '#') {
    Swal.fire({
      icon: 'info',
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || CONFIG.projectDefaults.githubBase,
        Link: selectedProject.Link || CONFIG.projectDefaults.demoBase,
      };
